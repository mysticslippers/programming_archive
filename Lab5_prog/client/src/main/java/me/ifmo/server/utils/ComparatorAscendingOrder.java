...
public class ComparatorAscendingOrder implements Comparator<Dragon>{

    /**
     * Method for sorting the collection by the numberOfTreasures field of the DragonCave class in ascending order.
